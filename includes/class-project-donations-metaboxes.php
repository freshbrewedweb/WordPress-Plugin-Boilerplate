...
class Project_Donations_Metaboxes
{
	 ...
	 */
	function get_project_options( $query_args ) {
	...
	function yourprefix_register_demo_metabox() {
		...
		$cmb_demo->add_field( array(
			'name'             => __( 'Projects', 'cmb2' ),
			'desc'             => __( 'Donation made to these projects.', 'cmb2' ),
			'id'               => $prefix . 'select',
			'type'             => 'radio',
			'show_option_none' => true,
			'options_cb' => array($this, 'donation_projects'),
		) );
